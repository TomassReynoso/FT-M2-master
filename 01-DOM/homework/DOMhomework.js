...
// createdBy.innerHTML = createdBy.innerHTML + "Tomás Reynoso";

let span = document.querySelector("#createdBy");
span.innerHTML = span.innerHTML + " Tomás Reynoso";
...
function buildToDo(todo, index) {
  ...
  // toDoShell = <div><div/>
  toDoShell.classList.add("toDoShell");                    //toDoShell.className("toDoShell");                     
  ...
  if (todo.complete) toDoText.classList.add("completeText");      //if (todo.complete) toDoText.className("completeText");
...
function buildToDos(toDos) {
  // toDos ya es un array lleno de objetos
  // Tu código acá:
